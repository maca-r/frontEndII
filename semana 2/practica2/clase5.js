...
function elegirTema() {
    ...
    let botonCambiarTema = document.querySelector(".tema button")

    botonCambiarTema.addEventListener("click", evento => {
        if(confirm("¿Desea cambiar el tema?")){
            let temaDark = body.classList.toggle("dark")
            if(temaDark){
                botonCambiarTema.innerText = "Cambiar a modo claro 🌞";
                botonCambiarTema.style.backgroundColor = "white";
                botonCambiarTema.style.color = "black";
            } else{
                botonCambiarTema.innerText = "Cambiar a modo oscuro 🌛";
                botonCambiarTema.style.backgroundColor = "black";
                botonCambiarTema.style.color = "white";
            } 
        }
    }
